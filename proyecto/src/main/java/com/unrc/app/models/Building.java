...
//como vas a ver en SQL, como es una relación de 1 a N, la tabla buildings tiene el id del dueño, ya que así
...
/* Es una convención que los nombres de las clases esten en ingles y las tablas tambien, pero es necesaria,
 ...
 para la relacion N a N, en este caso entre inmobiliarias y dueños, es necesaria la convencion que respete
 * yo, la de:
